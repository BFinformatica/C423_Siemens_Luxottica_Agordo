        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $('#genera_grafico').click(function () {
                    ...
                    var inizio, fine = "";
                    try {
                        inizio = $('#MainContent_inizio').val().replace("-", "/");
                    }
                    catch{
                        inizio = "";
                    }
                    try {
                        fine = $('#MainContent_fine').val().replace("-", "/");
                    }
                    catch{
                        fine = inizio;
                    }
                    ...
                    $.ajax({
                        type: "POST",
                        //url: "Sinottico_ajax.svc/DoWork",
                        url: "CalcolaGrafico.aspx?stazione=1" + misure + "&tipo_medie=" + $("#MainContent_tipo_medie").val() + "&tipo_dati=" + $("#MainContent_tipo").val() + "&inizio=" + inizio + "&fine=" + fine + "&perc=1",
                        data: '{"tags":""}',
                        contentType: "application/json; charset=utf-8",
                        processData: false,
                        dataType: "text",
                    ...
                    response,
                    {
                        ...
                        pointClickCallback: function(event, p) {
                            ...
                            $.ajax({
                                type: "POST",
                                //url: "Sinottico_ajax.svc/DoWork",
                                url: "CalcolaGrafico.aspx?stazione=1" + misure + "&tipo_medie=" + $("#MainContent_tipo_medie").val() + "&tipo_dati=" + $("#MainContent_tipo").val() + "inizio=" + inizio + "&fine=" + fine + "&perc=0",
                                data: '{"tags":""}',
                                contentType: "application/json; charset=utf-8",
                                processData: false,
                                dataType: "text",
