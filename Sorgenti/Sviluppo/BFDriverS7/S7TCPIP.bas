...
Public Declare Function PLCInputRead Lib "S7TCPIP.DLL" (ByVal hPLCHandle As Long, ByVal sMerkerByte As Integer, ByVal sBytesAmount As Integer, ByRef pBuffer As Any)
Public Declare Function PLCOutputWrite Lib "S7TCPIP.DLL" (ByVal hPLCHandle As Long, ByVal sOutputByte As Integer, ByVal sBytesAmount As Integer, ByRef pBuffer As Any)
